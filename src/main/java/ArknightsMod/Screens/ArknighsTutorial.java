...
public class ArknighsTutorial extends FtueTip {
    private static final TutorialStrings tutorialStrings = CardCrawlGame.languagePack.getTutorialString("TUTORIAL");
    private static final String[] txt = tutorialStrings.TEXT;
    ...
    public ArknighsTutorial() {
        this.img1 = ImageMaster.loadImage("ArkImg/UI/tips/t1.png");
        this.img2 = ImageMaster.loadImage("ArkImg/UI/tips/t2.png");
        this.img3 = ImageMaster.loadImage("ArkImg/UI/tips/t3.png");
        this.img4 = ImageMaster.loadImage("ArkImg/UI/tips/t4.png");
        this.closeScreen = -3;
    ...
    public void update() {
        ...
        if ((AbstractDungeon.overlayMenu.proceedButton.isHovered && InputHelper.justClickedLeft) || CInputActionSet.proceed.isJustPressed()) {
            ...
            if (this.currentSlot <= this.closeScreen) {
                ...
                Arknights.activeTutorials[0] = false;
                try {
                    Arknights.saveData();
