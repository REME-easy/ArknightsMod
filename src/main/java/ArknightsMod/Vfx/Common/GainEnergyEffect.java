...
public class GainEnergyEffect extends AbstractGameEffect {
    ...
    private TextureAtlas.AtlasRegion energyImg;

    public GainEnergyEffect(AbstractOperator o) {
        this.img = ImageMaster.GLOW_SPARK_2;
        this.pos = new Vector2(o.drawX, o.drawY);
        this.target = new Vector2(198.0F * Settings.xScale, 190.0F * Settings.yScale);
    ...
    public void render(SpriteBatch sb) {
        if (!this.isDone) {
            ...
            //sb.draw(this.energyImg, this.points[0].x - (float)(this.energyImg.packedWidth / 2), this.points[0].y - (float)(this.energyImg.packedHeight / 2), (float)this.energyImg.packedWidth / 2.0F, (float)this.energyImg.packedHeight / 2.0F, (float)this.energyImg.packedWidth, (float)this.energyImg.packedHeight, Settings.scale * 1.0F, Settings.scale * 1.0F, this.rotation);
