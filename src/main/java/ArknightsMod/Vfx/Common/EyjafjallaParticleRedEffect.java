...
public class EyjafjallaParticleRedEffect extends AbstractGameEffect {
    ...
    public EyjafjallaParticleRedEffect(float x, float y, float dx, float dy) {
        this.setImg();
        this.startingDuration = MathUtils.random(0.2F, 0.5F);
        this.duration = this.startingDuration;
        float r = MathUtils.random(-3.0F, 3.0F) * MathUtils.random(-3.0F, 3.0F);
