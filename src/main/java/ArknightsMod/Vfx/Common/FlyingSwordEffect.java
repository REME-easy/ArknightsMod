...
public class FlyingSwordEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public FlyingSwordEffect(float x, float y, float fAngle, boolean shouldFlip) {
    ...
    public void update() {
        ...
        this.y += derp.y * Gdx.graphics.getDeltaTime() * 5000.0F * this.scaleMultiplier * Settings.scale;
