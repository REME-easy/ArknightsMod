...
public class OperatorParticleGreyEffect extends AbstractGameEffect {
    ...
    public OperatorParticleGreyEffect(float x, float y) {
        this.setImg();
        ...
        float tmp = MathUtils.random(0.0F, 1.0F);
        this.color = new Color(tmp, tmp, tmp, 0.0F);
