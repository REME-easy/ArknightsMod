...
public class ExhaustEmberBlueEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vX;
    private float vY;
    ...
    public ExhaustEmberBlueEffect(float x, float y) {
        ...
        this.x = x + MathUtils.random(-70.0F * Settings.scale, 75.0F * Settings.scale);
        this.y = y + MathUtils.random(-120.0F * Settings.scale, 75.0F * Settings.scale);
        this.scale = 0.01F;
