...
public class SotisdShieldFlashEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private TextureAtlas.AtlasRegion img;

    public SotisdShieldFlashEffect(float x, float y) {
        ...
        this.rotation = 0.0F;
        this.color = new Color(MathUtils.random(0.2F, 0.4F), MathUtils.random(0.2F, 0.4F), MathUtils.random(0.8F, 1.0F), 0.01F);
    }
