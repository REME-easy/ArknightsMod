...
public class OperatorParticleGreenEffect extends AbstractGameEffect {
    ...
    public OperatorParticleGreenEffect(float x, float y) {
        this.setImg();
        ...
        var10000 = this.color;
        var10000.b -= this.color.r - MathUtils.random(0.5F);
