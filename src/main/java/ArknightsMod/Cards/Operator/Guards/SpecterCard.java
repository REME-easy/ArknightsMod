...
import ArknightsMod.Operators.Guards.Specter.Specter_1;
import ArknightsMod.Operators.Guards.Specter.Specter_2;
...
public class SpecterCard extends AbstractOperatorCard {
    ...
    public ArrayList<AbstractSkill> getSkills() {
        ...
        tmp.add(new Specter_1());
        tmp.add(new Specter_2());
        return tmp;
    }
