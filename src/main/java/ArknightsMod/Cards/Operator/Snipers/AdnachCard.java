...
import ArknightsMod.Operators.Snipers.Adnachiel.Adnachiel;
import ArknightsMod.Operators.Snipers.Adnachiel.Adnachiel_1;
...
public class AdnachCard extends AbstractOperatorCard {
    private static final String ID = "Arknights_Adnachiel";
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = cardStrings.NAME;
    private static final String DESCRIPTION = cardStrings.DESCRIPTION;
    private static final String[] EXTENDED_DESCRIPTION = cardStrings.EXTENDED_DESCRIPTION;
    private static final String IMG_PATH = "ArkImg/card/operator/AdnachCard.png";
