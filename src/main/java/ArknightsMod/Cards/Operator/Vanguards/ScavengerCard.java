...
import ArknightsMod.Operators.Vanguards.Scavenger.Scavenger;
import ArknightsMod.Operators.Vanguards.Scavenger.Scavenger_1;
import ArknightsMod.Operators.Vanguards.Scavenger.Scavenger_2;
...
public class ScavengerCard extends AbstractOperatorCard {
    ...
    public ArrayList<AbstractSkill> getSkills() {
        ...
        tmp.add(new Scavenger_1());
        tmp.add(new Scavenger_2());
        return tmp;
    }
