...
import ArknightsMod.Operators.Vanguards.Courier.Courier;
import ArknightsMod.Operators.Vanguards.Courier.Courier_1;
import ArknightsMod.Operators.Vanguards.Courier.Courier_2;
...
public class CourierCard extends AbstractOperatorCard {
    ...
    public ArrayList<AbstractSkill> getSkills() {
        ...
        tmp.add(new Courier_1());
        tmp.add(new Courier_2());
        return tmp;
    }
