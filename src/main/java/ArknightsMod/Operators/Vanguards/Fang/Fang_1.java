...
public class Fang_1 extends AbstractSkill {
    private static final boolean IS_AUTOMATIC = true;
    private static final int MAX_SKILLPOINT = 6;
    ...
    public void ActiveEffect() {
        this.addToBot(new GainEnergyEffectAction(this.owner, 1));
    ...
    public TextureAtlas.AtlasRegion getTexture() {
        return ArknightsImageMaster.CHARGE_COST_1;
    }
}
