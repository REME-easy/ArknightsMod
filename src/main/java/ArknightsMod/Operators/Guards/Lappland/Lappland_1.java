...
import ArknightsMod.Powers.Operator.LapplandPower;
...
public class Lappland_1 extends AbstractSkill {
    ...
    public void ActiveEffect() {
        ...
        this.addToBot(new ApplyPowerAction(this.owner, this.owner, new StrengthPower(this.owner, 4)));
        this.addToBot(new ApplyPowerAction(this.owner, this.owner, new LapplandPower(this.owner)));
    }
    ...
    public TextureAtlas.AtlasRegion getTexture() {
        return ArknightsImageMaster.LAPPLAND_1;
    }
